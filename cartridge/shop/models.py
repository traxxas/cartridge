...
class Order(SiteRelated):
    ...
    billing_detail_postcode = CharField(_("Zip"), max_length=10)
    billing_detail_country = CharField(_("Country"), default='US', max_length=100)
    ...
    shipping_detail_postcode = CharField(_("Zip"), max_length=10)
    shipping_detail_country = CharField(_("Country"), default='US', max_length=100)
